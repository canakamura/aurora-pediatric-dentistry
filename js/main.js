function initialize_gmap(t, e, i, o, n, s, a) {
    ...
    var l = Math.max(document.documentElement.clientWidth, window.innerWidth || 0),
        ...
        p = new google.maps.Map(document.getElementById("map_canvas"), c),
        f = '<div id="content" style="text-align:left;"><div id="siteNotice"></div><a href="' + a + '" target="_blank"><h4>' + s + '<br><small>(Click for directions)</small></h4></a><div id="bodyContent"><p>' + n + "</p></div></div>",
    ...
    u.open(p, g);
    var m;
    google.maps.event.addDomListener(p, "idle", function() {
        r()
...
function(t) {
    var e = {
            common: {
                init: function() {
                    function e() {
                        "block" == t(".test-size").css("display") ? t(".g-recaptcha").css({
                    ...
                    t(".hamburger").click(function() {
                        t(".hamburger").toggleClass("is-active"), t("#sideNav").toggleClass("sideNav-open"), t(".sideNavBody").toggleClass("sideNavBody-push"), i = !1
                    }), t(".sideNav").click(function() {
                        i = !1
                    }), t("html").click(function() {
                        i && (t(".hamburger").removeClass("is-active"), t("#sideNav").removeClass("sideNav-open"), t(".sideNavBody").removeClass("sideNavBody-push")), i = !0
                    ...
                    }), t("#testimonialCarousel").carousel({
                        interval: 7e3
                    })
                },
                finalize: function() {}
